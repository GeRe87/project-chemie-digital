...
VALIDATION_SPEC = importlib.util.spec_from_file_location(
    "validate_semantics", SCRIPTS / "validate_semantics.py"
)
...
EXPECTED_STEPS = {
    EX["path-step-chemometrics-mean-values-arithmetic-mean"]: (
        1,
        {
    ...
    EX["path-step-chemometrics-mean-values-expected-value"]: (
        2,
        {
    ...
    EX["path-step-chemometrics-mean-values-law-of-large-numbers"]: (
        3,
        {
    ...
    EX["path-step-chemometrics-mean-values-geometric-mean"]: (
        4,
        {
    ...
    EX["path-step-chemometrics-mean-values-geometric-practice"]: (
        5,
        {EX["exercise-geometric-growth-factors"]},
    ),
    EX["path-step-chemometrics-mean-values-harmonic-mean"]: (
        6,
        {
    ...
    EX["path-step-chemometrics-mean-values-median"]: (
        7,
        {
    ...
    EX["path-step-chemometrics-mean-values-median-practice"]: (
        8,
...
class ChemometricsMeanValuesPathTests(unittest.TestCase):
    ...
    def test_topics_are_exactly_the_unordered_learning_unit_focus_set(self) -> None:
        ...
        unit_topics = set(
            self.course_graph.objects(EX["learning-unit-mean-values"], CD.hasFocusConcept)
        )
            ...
            with self.subTest(step=step):
                ...
                for resource in expected_resources:
                    self.assertTrue(
                        ...
                        f"Reviewed Mean Values resource is absent from the Chemometrics content graph: {resource}",
                    )
                    self.assertIn(
                        Literal(True),
